-- Hell — dark, arterial red with loot-color syntax accents
...
local c = {
	...
	-- Signature
	signature = "#C8201E", -- arterial red

	-- Loot colors (shared hues, saturated for dark)
	common    = "#E8D9C7", -- white rarity → text
	magic     = "#4A9EFF", -- blue / rune
	rare      = "#F0C84A", -- yellow / sulfur
	legendary = "#FF7B1C", -- orange / ember
	unique    = "#A470E0", -- purple / demon violet
...
hl("MoreMsg",       { fg = c.magic })
hl("Question",      { fg = c.magic })
...
hl("@markup.heading.2",     { fg = c.legendary, bold = true })
hl("@markup.heading.3",     { fg = c.rare, bold = true })
hl("@markup.heading.4",     { fg = c.magic, bold = true })
...
-- Tinted bg per heading level, matching loot palette: H1 red, H2 orange, H3 yellow, H4 blue, H5 purple, H6 cyan
hl("Headline",            { bg = c.bg_alt })
hl("Headline1",           { fg = c.signature, bg = "#380D0D", bold = true })
hl("Headline2",           { fg = c.legendary, bg = "#431F0D", bold = true })
hl("Headline3",           { fg = c.rare,      bg = "#402F16", bold = true })
hl("Headline4",           { fg = c.magic,     bg = "#1F273A", bold = true })
hl("Headline5",           { fg = c.unique,    bg = "#311D34", bold = true })
hl("Headline6",           { fg = c.cyan,      bg = "#223132", bold = true })
...
hl("RenderMarkdownH1Bg",  { bg = "#380D0D" })
hl("RenderMarkdownH2Bg",  { bg = "#431F0D" })
hl("RenderMarkdownH3Bg",  { bg = "#402F16" })
hl("RenderMarkdownH4Bg",  { bg = "#1F273A" })
hl("RenderMarkdownH5Bg",  { bg = "#311D34" })
hl("RenderMarkdownH6Bg",  { bg = "#223132" })
...
hl("NvimTreeFolderName",      { fg = c.magic })
hl("NvimTreeOpenedFolderName",{ fg = c.magic, bold = true })
hl("NvimTreeFolderIcon",      { fg = c.rare })
hl("NvimTreeRootFolder",      { fg = c.signature, bold = true })
...
hl("NeoTreeDirectoryName",    { fg = c.magic })
hl("NeoTreeDirectoryIcon",    { fg = c.rare })
hl("NeoTreeRootName",         { fg = c.signature, bold = true })
...
vim.g.terminal_color_0  = "#1F1312"
vim.g.terminal_color_1  = "#C8201E"
vim.g.terminal_color_2  = "#6A9955"
vim.g.terminal_color_3  = "#F0C84A"
vim.g.terminal_color_4  = "#4A9EFF"
vim.g.terminal_color_5  = "#A470E0"
vim.g.terminal_color_6  = "#5CD0D8"
vim.g.terminal_color_7  = "#E8D9C7"
vim.g.terminal_color_8  = "#3D2424"
vim.g.terminal_color_9  = "#FF4A3A"
vim.g.terminal_color_10 = "#7FB569"
vim.g.terminal_color_11 = "#FF7B1C"
vim.g.terminal_color_12 = "#6AB5FF"
vim.g.terminal_color_13 = "#C590F0"
vim.g.terminal_color_14 = "#7FE5EB"
vim.g.terminal_color_15 = "#F5F0E8"
